...
resource "aws_lambda_function" "lambda_from_terraform" {
    ...
    # 実行環境
    runtime = "ruby2.5" 
    # arn: https://docs.aws.amazon.com/ja_jp/general/latest/gr/aws-arns-and-namespaces.html
...
# s3とlogの権限を付与
# resource "aws_iam_policy" "lambda_s3_log_write" {
...
#   policy_arn = "${aws_iam_policy.lambda_s3_log_write.arn}"
# }
